...
const features = [
  {
    ...
    description: "Lightning-fast speed with optimized caching and edge delivery for the best user experience.",
    href: "#",
    cta: "Learn more",
  ...
  },
  {
    Icon: BarChart3,
    name: "Analytics",
    description: "Powerful analytics dashboard to track metrics and gain actionable insights.",
    href: "#",
    cta: "Learn more",
    className: "md:col-span-1 md:row-span-1",
  },
  ...
  },
  {
    Icon: Globe,
    name: "API First",
    description: "Build powerful integrations with our comprehensive REST and GraphQL APIs.",
    href: "#",
    cta: "Learn more",
    className: "md:col-span-1 md:row-span-1",
  },
...
const pricingTiers = [
  ...
  },
  {
    ...
    features: ["Everything in Pro", "Dedicated support", "SLA guarantee", "Unlimited storage", "Custom contracts"],
    cta: "Contact Sales",
    popular: false,
  },
];
    ...
    <section className="relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden px-4 py-20 md:px-8">
      ...
      <div className="relative z-10 flex max-w-5xl flex-col items-center text-center">
        ...
        <div className="mb-10 flex flex-col items-center gap-3 text-lg text-muted-foreground sm:text-xl md:text-2xl">
          ...
          <TypingAnimation
            words={["building startups", "creating SaaS", "launching products", "scaling businesses"]}
    ...
    <section className="relative px-4 py-24 md:px-8 lg:py-32">
      <div className="container mx-auto">
        <div className="mb-16 text-center">
          ...
          >
            Powerful features to help you build, launch, and scale your products faster than ever.
          </TextAnimate>
        </div>
